// * ========================================================= FOLIO — script.js Every interaction on this page lives here. The pattern is always the same: FIND an element, LISTEN for an event, then CHANGE something. Three features: 1. Dark mode toggle 2. Back-to-top button 3. Scroll reveal (elements fade in as you scroll) ========================================================= */
